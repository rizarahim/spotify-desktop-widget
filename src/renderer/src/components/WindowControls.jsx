export default function WindowControls({ onThemeSwitch }) {
  return (
    <>
      ...
      <button
        className="no-drag absolute cursor-pointer right-22 top-14 z-10 text-xs text-white/50 hover:text-white"
        title="Minimize"
      ...
      <button
        className="no-drag absolute cursor-pointer right-18 top-14 z-10 text-xs text-white/50 hover:text-white"
        title="Close"
